import bookImage1 from '../who-moved-my-cheese.jpg';
import bookImage2 from '../Atomic-Habits.jpg';
import bookImage3 from '../Status-anxiety.jpg';
import bookImage4 from '../Emotional-intelligence.jpg';


function Books() {
  return (
  <div className="book-container">
        <img className="bool-cover" src={bookImage1}/>
